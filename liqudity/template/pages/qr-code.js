                  ...
                  <div class="absolute inset-0 bg-default-950/40">
                    <div class="flex items-center justify-center h-full">
                      <div class="text-center">
                        <div class="bg-white/30 backdrop-blur-3xl rounded-md h-44 w-44 inline-flex items-center justify-center">
                          <img
                            src="assets/images/ai/code-qr.png"
                            class="rounded-xl mx-auto h-40"
                            alt=""
                          />
                        </div>
                        <h5 class="text-xl font-bold text-white mb-3 mt-5">
                          Login with QR code.
                        </h5>
                    ...
                    <div class="mb-6">
                      <div class="flex flex-wrap items-center justify-between gap-y-1">
                        ...
                        <a
                          ...
                          class="text-default-200 border-b border-dashed"
                        >

                  ...
                  <div class="flex items-end justify-center h-full">
                    <div class="p-6 text-start">
                      <h5 class="text-xl font-bold text-white mb-3">
                        Is the best way, <br /> to build your marketing
                        strategy!
                      </h5>
                      <p class="text-base font-medium text-default-500">
              ...
              <div class="pb6 my-auto">
                ...
                <form action="#" class="text-start">
                  ...
                  <div class="mb-6">
                    ...
                    />
                    <label
                      class="ms-2 text-default-200 align-middle"
                      for="checkbox-signin"
                    >
                      Remember me
                    </label>
                  ...
                  <div class="mb-6 text-center">
                    <button
                      ...
                      type="submit"
                    >
                      <span class="fw-bold">Sing Up</span>{" "}
                    </button>
                  </div>
                </form>
              </div>
              <div>
                <div class="text-center">
                  ...
                  <ul class="flex flex-wrap items-center justify-center gap-2">
                    <li>
                      <a class="h-10 w-10 inline-flex items-center justify-center backdrop-blur-2xl bg-white/20 rounded-lg transition-all duration-500 group hover:bg-blue-600/60">
                    ...
                    <li>
                      <a class="h-10 w-10 inline-flex items-center justify-center backdrop-blur-2xl bg-white/20 rounded-lg transition-all duration-500 group hover:bg-pink-600/60">
                    ...
                    <li>
                      <a class="h-10 w-10 inline-flex items-center justify-center backdrop-blur-2xl bg-white/20 rounded-lg transition-all duration-500 group hover:bg-blue-800/60">
                    ...
                    <li>
                      <a class="h-10 w-10 inline-flex items-center justify-center backdrop-blur-2xl bg-white/20 rounded-lg transition-all duration-500 group hover:bg-default-600/60">
